...
const BG_URL = "/images/CinematicHeaderBridgeOurSolution.webp";

const CinematicHeaderSolution = () => {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            We don't just design. We synchronize.
          </p>
        </div>
      </div>

      {/* Sentinel — in document flow between necessity canvas and solution canvas */}
      <div
        ref={sentinelRef}
        className="solution-sentinel"
        style={{
          position: "relative",
          zIndex: 2,
          height: "100vh",
...
export default CinematicHeaderSolution;

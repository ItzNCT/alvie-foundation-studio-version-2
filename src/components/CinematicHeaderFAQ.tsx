...
const BG_URL = "/images/CinematicHeaderBridgeFAQ.webp";

const CinematicHeaderFAQ = () => {
    ...
    <>
      ...
      >
        <div
          ...
          style={{ background: "rgba(26, 26, 24, 0.45)", zIndex: 1 }}
        />
        <div
...
export default CinematicHeaderFAQ;
